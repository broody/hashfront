...
export const BRIDGEHEAD: MapDef = {
  ...
  startingUnits: [
    ...
    { type: "Artillery", playerId: 1, x: 3, y: 2 },
    { type: "Artillery", playerId: 1, x: 5, y: 1 },
    ...
    { type: "Artillery", playerId: 2, x: 16, y: 17 },
    { type: "Artillery", playerId: 2, x: 14, y: 18 },
...
export const CROSSROADS: MapDef = {
  ...
  startingUnits: [
    ...
    { type: "Artillery", playerId: 1, x: 2, y: 2 },
    { type: "Artillery", playerId: 1, x: 4, y: 0 },
    { type: "Tank", playerId: 1, x: 3, y: 1 },
    { type: "Infantry", playerId: 2, x: 16, y: 19 },
    { type: "Infantry", playerId: 2, x: 17, y: 18 },
    { type: "Infantry", playerId: 2, x: 15, y: 18 },
    { type: "Infantry", playerId: 2, x: 16, y: 17 },
    { type: "Artillery", playerId: 2, x: 17, y: 17 },
    { type: "Artillery", playerId: 2, x: 15, y: 19 },
    { type: "Tank", playerId: 2, x: 16, y: 18 },
  ],
};
...
export const AMBUSH: MapDef = {
  ...
  startingUnits: [
    ...
    { type: "Artillery", playerId: 1, x: 3, y: 0 },
    { type: "Artillery", playerId: 1, x: 0, y: 3 },
    ...
    { type: "Artillery", playerId: 2, x: 19, y: 17 },
    { type: "Artillery", playerId: 2, x: 17, y: 19 },
